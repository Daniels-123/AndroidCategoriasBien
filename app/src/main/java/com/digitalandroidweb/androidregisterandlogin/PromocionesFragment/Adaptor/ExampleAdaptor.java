package com.digitalandroidweb.androidregisterandlogin.PromocionesFragment.Adaptor;
...
public class ExampleAdaptor extends RecyclerView.Adapter<ExampleAdaptor.ExampleViewHolder> {
    ...
    public ExampleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.example_item_promociones, parent, false);
    ...
    public class ExampleViewHolder extends RecyclerView.ViewHolder{
        ...
        public ExampleViewHolder(View itemView) {
            super(itemView);
            mImageView = itemView.findViewById(R.id.image_view_promociones);
            mTextViewCreator = itemView.findViewById(R.id.text_view_promocio);
            mTextViewDescription= itemView.findViewById(R.id.text_promociones);

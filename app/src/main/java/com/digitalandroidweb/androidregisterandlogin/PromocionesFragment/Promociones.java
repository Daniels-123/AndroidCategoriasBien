...
import com.digitalandroidweb.androidregisterandlogin.PromocionesFragment.Adaptor.ExampleAdaptor;
import com.digitalandroidweb.androidregisterandlogin.PromocionesFragment.Adaptor.ExampleItem;
...
public class Promociones extends AppCompatActivity implements ExampleAdaptor.OnItemClickListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle(R.string.promociones);
    ...
    private void parseJSON() {
        ...
        String url = "http://openfirespark.000webhostapp.com/pruebassql/categorias/Promociones.php";
                ...
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            ...
                            mExampleAdaptor = new ExampleAdaptor(Promociones.this, mexampleItems);
                            mRecyclerView.setAdapter(mExampleAdaptor);
                            mExampleAdaptor.setOnClickItemListener(Promociones.this );

...
public class BebesDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageView imageView = findViewById(R.id.image_view_detail_bebes);
        TextView textViewNombre = findViewById(R.id.text_view_nombre_det_bebes);
        TextView textViewDesc = findViewById(R.id.text_view_descrip_det_bebes);
        TextView textViewDire = findViewById(R.id.text_view_direccion_det_bebes);
        TextView textViewTel = findViewById(R.id.text_view_telefono_det_bebes);
